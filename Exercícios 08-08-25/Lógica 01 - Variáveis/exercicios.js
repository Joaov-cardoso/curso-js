function exercicio1() {
    ...
    console.log("Olá, meu nome é " + nome + ", " + "tenho " + idade + " " + "anos e minha altura é de " + altura.toString().replace(".", ",") + " " + "metros");
    alert("Olá, meu nome é " + nome + ", " + "tenho " + idade + " " + "anos e minha altura é de " + altura.toString().replace(".", ",") + " " + "metros");
}
...
function exercicio5() {
    ...
    alert("Área do retânlugo é de " + area + " " + "metros quadrados.")
...
function exercicio7() {
    ...
    alert("O valor com desconto é de R$" + valorComDesconto)
...
function exercicio8() {
    ...
    alert("A temperatura em Fahrenheit é de " + temperaturaFahrenheit + "ºF");
...
function exercicio10() {
    let valor1 = prompt("Digite um valor o primeiro valor");
