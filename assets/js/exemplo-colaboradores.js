...
console.log(colaboradoresNomes.sort())//sort está organizando em ordem alfabética neste exemplo

// Criar uma lista com os nomes completos dos colaboradores
// tenho uma lista de objetos, quero gerar uma lista de string
let colaboresNomesCompletos = colaboradores.map(colaborador => {
...
// Criar ums lista com o nome e calcular a idade do colaborador
let colaboradoresIdades = colaboradores.map(colaborador =>{
    ...
    // colagorador.data_nascimento => "1992-02-03"
