...
function apresentarMensagemUsuario(){
    alert("Minha primeira mensagem JS ao usuário")
}


// <button onclick="exemploVariaveisInteiras()">Somar inteiros fixos</button>
// PADRÃO DE NOMENCLATURA DE FUNÇÕES EM JAVASCRIPT É camelCase
...
function exemploVariaveisString(){
    ...
    // Concatenação judar duas coisas "Ana" "Maria" = "AnaMaria"
